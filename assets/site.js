...
(function () {
  ...
  var navMobile = NAV.map(function (n) {
    ...
    '<a href="eng/" class="m-link" style="font-size:16px;opacity:.6;letter-spacing:.08em;">English</a>';
  ...
  '<header id="siteHeader" class="scrolled">' +
    '<div style="max-width:1500px;margin:0 auto;padding:0 clamp(20px,5vw,60px);height:88px;display:grid;grid-template-columns:1fr auto 1fr;align-items:center;gap:24px;">' +
      '<a href="index.html" style="justify-self:start;color:inherit;text-decoration:none;display:flex;align-items:baseline;gap:13px;">' +
        '<span style="font-family:\'Cafe24Classictype\',serif;font-weight:400;font-size:34px;line-height:.9;letter-spacing:.02em;">CMK</span>' +
        '<span style="font-size:11px;font-weight:500;letter-spacing:.26em;opacity:.55;">IMAGE KOREA</span>' +
      '</a>' +
      ...
      '<div style="justify-self:end;display:flex;align-items:center;gap:20px;">' +
        '<span class="langswitch"><a class="cur" href="index.html">KO</a><span class="sep">/</span><a class="alt" href="eng/">EN</a></span>' +
  ...
  '<footer style="background:#BDB29B;color:#6B6353;padding:clamp(56px,8vh,88px) clamp(20px,5vw,60px) 40px;">' +
    '<div style="max-width:1500px;margin:0 auto;">' +
      '<div class="grid-foot" style="display:grid;grid-template-columns:1fr auto;gap:40px;padding-bottom:44px;border-bottom:1px solid rgba(42,38,34,.14);align-items:start;">' +
        '<div>' +
          '<div style="display:flex;align-items:baseline;gap:9px;margin-bottom:16px;"><span style="font-family:\'Cafe24Classictype\',serif;font-weight:400;font-size:30px;line-height:.9;letter-spacing:.02em;color:#211C17;">CMK</span><span style="font-size:10px;font-weight:500;letter-spacing:.24em;color:#8A8276;">IMAGE KOREA · SINCE 2008</span></div>' +
          '<p style="font-weight:300;font-size:13px;line-height:1.8;max-width:30ch;margin:0;">리더와 기관의 이미지를 전략으로 설계하는 이미지 컨설팅 그룹.</p>' +
        '</div>' +
        '<div>' +
      ...
      '<div style="padding-top:24px;font-size:11.5px;line-height:1.9;color:#8A8276;">' +
        '<div style="margin-bottom:6px;">CMK Image Korea &nbsp;|&nbsp; 대표 조미경 &nbsp;|&nbsp; 사업자등록번호 107-91-45820</div>' +
        '<div style="margin-bottom:14px;">경기 용인시 기흥구 탑실로 116, 탑실마을 대주 피오레 2단지 215동 303호 &nbsp;|&nbsp; Tel 031-284-2566 &nbsp;|&nbsp; cmkimage@hanmail.net</div>' +
